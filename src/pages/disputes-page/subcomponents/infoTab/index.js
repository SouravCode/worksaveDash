...
function InfoTab({
  ...
  let disputeDetails = cloneDeep(data);
  let disputeReason = [];
  let latestDispute;
  ...
  const Status = async () => {
    ...
    const apiResponce = await getStatus(type, accessToken);
  ...
  if (data.dispute && data.dispute.length > 0) {
    ...
    disputeReason = cloneDeep(latestDispute[0]);
  }
  ...
  if (formData && formData.current) {
    formData.current.referenceId = disputeDetails.id;
  }
  let form = useRef({});
  const clearState = () => {
    setformData(form);
          ...
          <div className={"AdminmessageBox"}>
            <div className={"chatContainer"}>
              ...
              <div className={"status f-right"}>
                <span>Status</span>
                <span className={"statustype"}>{data.data.status}</span>
              </div>
            </div>
          </div>
        ) : (
    ...
    <React.Fragment>
      <div className="popup-modal">
          ...
          <div className="d-flex">
            <div className="d-label">
              ...
              <div>
                ...
                <p className="val">{disputeDetails.transactionId}</p>
              </div>
            </div>
            <div className="d-label">
              <div>
              ...
              <div>
                ...
                <p className="val">{disputeDetails.cardLastNumbers}</p>
              </div>
            </div>
          </div>
          <div className="d-flex">
            <div className="d-label">
              ...
              <div>
                ...
                <p className="val">
                  £ {disputeDetails.amount && disputeDetails.amount}
                </p>
              </div>
            </div>
            ...
            <div className="d-label">
              ...
              <div>
                ...
                <p className="val">
                  £ {disputeDetails.cashback && disputeDetails.cashback}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="dispute-comments">
          ...
          <div className={"body"}>
            <DataGrid
              dataSource={disputeDetails.dispute}
          ...
          >
            ...
            <GroupItem colCount={2}>
              <ButtonItem>
                <ButtonOptions
                  type={"disputeBtn"}
                  onClick={() => onUpdateDispute(disputeReason)}
